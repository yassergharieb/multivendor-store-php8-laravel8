<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item  open ">
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{ route('admin.logout') }}"
                            data-i18n="nav.dash.ecommerce"> تسجيل الخروج</a>
                    </li>
                    {{-- <li><a class="menu-item" href="{{ route('langs.create') }}" data-i18n="nav.dash.crypto">أضافة
                            لغة جديده </a>
                    </li> --}}
                </ul>
            </li>
            ...
            <li class="nav-item  open ">
                <a href=""><i class="la la-home"></i>
                    ...
                    <span class="badge badge badge-info badge-pill float-right mr-2"> اللغات</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{ route('langs.index') }}"
            ...
            <li class="nav-item">
              <a href="{{ route('categories.index') }}"><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">الاقسام الرئيسيه </span>

                    <span class="badge badge badge-danger badge-pill float-right mr-2"> 40</span>
              </a>
                <ul class="menu-content">
                    <li class="active">
           ...
           {{-- <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{ __('messages.subcategories') }} </span>
                ...
                {{-- <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('SubCategories.index')}}"
                                          data-i18n="nav.dash.ecommerce">{{__('messages.displayAll')}}</a>
                    </li>
                    <li><a class="menu-item" href="{{route('SubCategories.create')}}" data-i18n="nav.dash.crypto">
                       {{__('messages.createNewSUbCat')}} </a> 
             </li> --}}
        

        

        <li class="nav-item open" ><a href=""><i class="la la-male"></i>
                <span class="menu-title" data-i18n="nav.dash.main">المتاجر </span>
                <span class="badge badge badge-success badge-pill float-right mr-2">#######</span>
            </a>
            <ul class="menu-content">
                <li class="active"><a class="menu-item" href="{{route('vendor.index')}}" data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                </li>
        ...
        <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
            ...
            {{-- <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">وسائل التوصيل</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('shipingMethod.edit' , 'free')}}"
                                   data-i18n="nav.templates.vert.classic_menu">توصيل مجاني</a>
                            </li>
                            <li><a class="menu-item" href="{{route('shipingMethod.edit' , 'local')}}"> توصيل داخلي</a>
                            </li>
        ...
        <li class=" nav-item"><a href="#"><i class="la la-arrows-h"></i><span class="menu-title"
            ...
            <ul class="menu-content">
                <li><a class="menu-item" href="#"
                        data-i18n="nav.horz_nav.horizontal_navigation_types.main">Navigation
                        Types</a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="../horizontal-menu-template"
        ...
        <li class=" nav-item"><a href="#"><i class="la la-download"></i><span class="menu-title"
            ...
            <ul class="menu-content">
                ...
                <li><a class="menu-item" href="footer-transparent.html"
                        data-i18n="nav.footers.footer_transparent">Footer
                        Transparent</a>
                </li>
        ...
        <li class=" nav-item"><a href="#"><i class="la la-image"></i><span class="menu-title"
            ...
            <ul class="menu-content">
                ...
                <li><a class="menu-item" href="gallery-masonry.html"
                        data-i18n="nav.gallery_pages.gallery_masonry">Masonry
                        Gallery</a>
                </li>
        ...
        <li class=" nav-item"><a href="#"><i class="la la-unlock"></i><span class="menu-title"
            ...
            <ul class="menu-content">
                <li><a class="menu-item" href="login-simple.html"
                        data-i18n="nav.login_register_pages.login_simple">Login
                        Simple</a>
                </li>
        ...
        <li class=" nav-item"><a href="#"><i class="la la-eye"></i><span class="menu-title"
            ...
            <ul class="menu-content">
                ...
                <li><a class="menu-item" href="icons-simple-line-icons.html"
                        data-i18n="nav.icons.icons_linecons">Simple
                        Line Icons</a>
                </li>
            </ul>
        </li>
        ...
        <li class=" navigation-header">
            <span data-i18n="nav.category.addons">Add Ons</span><i class="la la-ellipsis-h ft-minus"
                data-toggle="tooltip" data-placement="right" data-original-title="Add Ons"></i>
        </li>
