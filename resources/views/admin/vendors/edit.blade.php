                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('vendor.update',$vendor ->id)}}"
                                              method="POST"
                                            ...
                                            @csrf
                                             ...
                                             <input type="hidden"  value="{{!$vendor ->locations[0]->latitude ? $vendor ->locations[0]->latitude : "" }}" id="latitude" name="latitude">
                                             <input type="hidden" value="{{!$vendor ->locations[0]->longitude ? $vendor ->locations[0]->longitude : ""}}" id="longitude"  name="longitude">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="cats_ids[]" class="select2 form-control" multiple> 
        ...
        function initAutocomplete() {
            ...
            function geocodeLatLng(geocoder, map, infowindow,markerCurrent) {
                ...
                //  let longVal =   document.getElementById('longitude');
                 latVal.value = markerCurrent.position.lat();
                 longVal.value =  markerCurrent.position.lng();
