                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('vendor.store')}}"
                                              method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput2"> أختر الاقسام </label>
                                                            <select name="cat_ids[]" class="select2 form-control" multiple>
        ...
        function initAutocomplete() {
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(function(position) {
                 ...
                 latVal.value =  pos.lat;
                 longVal.value =  pos.lng;
                ...
                geocoder.geocode({
                    ...
                    if (status == google.maps.GeocoderStatus.OK) {
                        if (results[0]) {
                            ...
                            let pac_input  =  document.getElementById('pac_input');
                            pac_input.value =  results[0].formatted_address
                            console.log(pac_input.value)
